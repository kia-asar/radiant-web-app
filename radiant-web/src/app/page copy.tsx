...
import { ReviewPostComponent } from "@/components/review-post"
...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-4 bg-gradient-default">
        <ReviewPostComponent key={1} userName={"post.user_name"} postContent={"post.post_text"} />
    </div>
  )
}
